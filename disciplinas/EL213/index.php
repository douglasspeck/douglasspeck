...
<html lang="pt-BR">
    <head>
        <!-- Google tag (gtag.js) -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-TJN5YHMBY5"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-TJN5YHMBY5');
        </script>
        
        <title>EL213 – Libras e Ensino de Surdos</title>
        ...
        <!-- SEO -->
        <meta name="author" content="Douglas Speck, speck@ime.unicamp.br">
        <meta name="description" content="Registros pessoais do curso de Licenciatura em Matemática na Unicamp">
        <link rel="canonical" href="https://ime.unicamp.br/~speck">
        <meta name="robots" content="index, nofollow">
        <meta name="googlebot" content="index, nofollow">

        <!-- OpenGraph Meta Tags -->
        <meta name="og:email" content="speck@ime.unicamp.br">
        <meta name="og:phone_number" content="47988479362">
        <meta name="og:site_name" content="speck">
        <meta name="og:description" content="Registros pessoais do curso de Licenciatura em Matemática na Unicamp">
        ...
        <!-- Stylesheets -->
        <link rel="stylesheet" href="css/block-elements.css" type="text/css">
        <link rel="stylesheet" href="css/font-styling.css" type="text/css">
        <link rel="stylesheet" href="css/inline-elements.css" type="text/css">
        <link rel="stylesheet" href="css/lists.css" type="text/css">
        <link rel="stylesheet" href="css/main.css" type="text/css">
        <link rel="stylesheet" href="css/paragraphs.css" type="text/css">
        <link rel="stylesheet" href="css/quotes.css" type="text/css">
        <link rel="stylesheet" href="css/scrollbar.css" type="text/css">
        <link rel="stylesheet" href="css/symbols.css" type="text/css">
    </head>
    <body>
        <main>
            <header>
                <h1>
                    <span class="codigo">EL213</span>
                    <span class="disciplina">Libras e Ensino de Surdos</span>
                </h1>
            </header>
            <section>
                <h2>Docente</h2>
            ...
            <section>
                ...
                <section>
                    ...
                    <picture>
                        <img src="/~speck/assets/img/legal-recognition-of-sign-languages.png" alt="Infográfico apresentando o reconhecimento legal das línguas de sinais ao redor do mundo."></img>
            ...
            <section>
                ...
                <p>Referência Bibliográfica: <a href="docs/Libras-uma-introducao-cap-4.pdf" title="Libras – uma introdução – capítulo 4" target="_blank">Aspectos da gramática da Libras</a></p>
                <ul>
                    ...
                    <section>
                        ...
                        <ul>
                            <li>Configuração de mão (CM)
                                ...
                                <img src="/~speck/assets/img/libras-configuracoes-de-mao.png" alt="Montagem demonstrando todas as configurações de mão da Libras" height="400">
                            </li>
